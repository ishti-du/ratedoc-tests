...
def test_doctor_hospital_dropdown_flow(page: Page):
    ...
    # Locate Diagnostic Centers link under Browse
    page.locator("footer").get_by_text("Diagnostic Centers", exact=True).last.click()
    ...
    assert "Discover rated diagnostic labs and imaging centers near you" in page_text