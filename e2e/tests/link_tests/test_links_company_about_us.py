...
def test_doctor_hospital_dropdown_flow(page: Page):
    ...
    page.locator("footer").get_by_text("About Us", exact=True).last.click()
    ...
    assert "RateDoc helps patients discover providers, read real experiences, and share feedback that improves care." in page_text